...
var Re = import_react.useState, Ve = import_react.useRef;
function ze(e) {
...
function Ae({ children: e, className: t, defaultHeight: s = 0, listRef: r, onResize: n, onRowsRendered: o, overscanCount: i = 3, rowComponent: f, rowCount: l, rowHeight: c, rowProps: d, tagName: a = "div", style: h, ...p }) {
	const I = de(d), u = (0, import_react.useMemo)(() => (0, import_react.memo)(f, ue), [f]), [w, m] = (0, import_react.useState)(null), O = ze(c), { getCellBounds: x, getEstimatedSize: F, scrollToIndex: V, startIndexOverscan: z, startIndexVisible: $, stopIndexOverscan: y, stopIndexVisible: g } = te({
		containerElement: w,
		containerStyle: h,
		...
		itemCount: l,
		itemProps: I,
		itemSize: (0, import_react.useMemo)(() => O ? (b) => c.getRowHeight(b) ?? c.getAverageRowHeight() : c, [O, c]),
		onResize: n,
		overscanCount: i
	});
	...
	const S = (0, import_react.useMemo)(() => {
		...
		if (l > 0) for (let v = z; v <= y; v++) {
			const R = x(v);
			b.push(/* @__PURE__ */ (0, import_react.createElement)(u, {
				...I,
				ariaAttributes: {
					"aria-posinset": v + 1,
					"aria-setsize": l,
...
function ke({ defaultRowHeight: e, key: t }) {
	...
	}, [e, n]), i = (0, import_react.useCallback)((a) => {
		const h = n.get(a);
		return h !== void 0 ? h : (n.set(a, e), e);
	}, [e, n]), f = (0, import_react.useCallback)((a, h) => {
		r((p) => {
	...
	const d = (0, import_react.useCallback)((a) => c ? (a.forEach((h) => c.observe(h)), () => {
...
var Le = import_react.useState, Me = import_react.useRef;
var C = -1;
function $e(e = !1) {
	if (C === -1 || e) {
		const t = document.createElement("div"), s = t.style;
...
//#endregion
export { Ee as Grid, Ae as List, $e as getScrollbarSize, ke as useDynamicRowHeight, Re as useGridCallbackRef, Ve as useGridRef, Le as useListCallbackRef, Me as useListRef };
